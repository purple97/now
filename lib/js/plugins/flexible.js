/**
 * Created by chendezhao on 14-12-1.
 * 10949221@qq.com
 */
!function (a) {
    function b() {
    ...
    var c, d, e, f = a.document, g = f.documentElement, h = f.querySelector('meta[name="viewport"]'), i = f.querySelector('meta[name="flexible"]'),av=a.navigator.appVersion;
    if (h) {
        console.warn("使用已有的meta标签来设置缩放比例");
    ...
    if (!c && !d) {
        var k = (av.match(/android/gi), av.match(/iphone/gi)), c = a.devicePixelRatio;
        c = k ? c >= 3 ? 3 : c >= 2 ? 2 : 1 : 1, d = 1 / c
    }
    g.getAttribute("data-devtype",av.match(/iphone/gi)?"iphone":"android");
