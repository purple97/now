...
!function (global) {
    var tvp = {};
    tvp.lastModify = "2014-12-31 14:14:29", tvp.ver = "$V2.0Build3319$", tvp.name = "\u817e\u8baf\u89c6\u9891\u7edf\u4e00\u64ad\u653e\u5668";
    var top = window.top;
    if (top != window)try {
    ...
    tvp.log = function (a) {
        ...
        tvp.log.isDebug = -1,
        tvp.log.debugid = 1,
        tvp.DEVICE = {aphone: 1, iphone: 2, ipad: 3, other: 0}, tvp.PLATFORM = {wechat: 1, mqq: 2, qqbrowser: 3, other: 0},
        tvp.APPID = {wechatPublic: 1e4, news: 10001, qqmusic: 10007},
        tvp.ACTION = {onVodH5Init: "tvp:vodhtml5:beforeInit", onFlashPlayerInited: "tvp:flash:inited"},
        function () {
            function a(a) {
    ...
    "undefined" != typeof Zepto && Zepto._tvp ? (tvp.$ = Zepto, _isUseInnerZepto = !0) : (tvp.$ = {}, _isUseInnerZepto = !1), function () {
        ...
        function b(b) {
            {
                var c = b.match(/MQQBrowser\/(\d+\.\d+)/i), d = b.match(/QQ\/(\d+\.(\d+)\.(\d+)\.(\d+))/i) || b.match(/V1_AND_SQ_([\d\.]+)/), e = b.match(/MicroMessenger\/((\d+)\.(\d+))\.(\d+)/) || b.match(/MicroMessenger\/((\d+)\.(\d+))/), f = b.match(/Mac\sOS\sX\s(\d+\.\d+)/), g = b.match(/Windows(\s+\w+)?\s+?(\d+\.\d+)/), h = b.match(/MiuiBrowser\/(\d+\.\d+)/i), i = b.match(/MI-ONE/), j = b.match(/MI PAD/), k = b.match(/UCBrowser\/(\d+\.\d+(\.\d+\.\d+)?)/) || b.match(/\sUC\s/), l = b.match(/IEMobile(\/|\s+)(\d+\.\d+)/) || b.match(/WPDesktop/), m = b.match(/(ipod).*\s([\d_]+)/i), n = b.match(/(iphone)\sos\s([\d_]+)/i), o = b.match(/Chrome\/(\d+\.\d+)/), p = b.match(/Mozilla.*Linux.*Android.*AppleWebKit.*Mobile Safari/), q = b.match(/(android)\s([\d\.]+)/i);
                b.indexOf("HTC") > -1
            }
            if (a.browser = a.browser || {}, a.os = a.os || {}, window.ActiveXObject) {
                var r = 6;
                (window.XMLHttpRequest || b.indexOf("MSIE 7.0") > -1) && (r = 7), (window.XDomainRequest || b.indexOf("Trident/4.0") > -1) && (r = 8), b.indexOf("Trident/5.0") > -1 && (r = 9), b.indexOf("Trident/6.0") > -1 && (r = 10), a.browser.ie = !0, a.browser.version = r
            } else b.indexOf("Trident/7.0") > -1 && (a.browser.ie = !0, a.browser.version = 11);
            q && (this.os.android = !0, this.os.version = q[2]), m && (this.os.ios = this.os.ipod = !0, this.os.version = m[2].replace(/_/g, ".")), n && (this.os.iphone = this.os.ios = !0, this.os.version = n[2].replace(/_/g, ".")), g && (this.os.windows = !0, this.os.version = g[2]), f && (this.os.Mac = !0, this.os.version = f[1]), b.indexOf("lepad_hls") > 0 && (this.os.LePad = !0), j && (this.os.MIPAD = !0), c && (this.browser.MQQ = !0, this.browser.version = c[1]), d && (this.browser.MQQClient = !0, this.browser.version = d[1]), e && (this.browser.WeChat = !0, this.browser.version = e[1]), h && (this.browser.MIUI = !0, this.browser.version = h[1]), k && (this.browser.UC = !0, this.browser.version = k[1] || 0 / 0), l && (this.browser.IEMobile = !0, this.browser.version = l[2]), p && (this.browser.AndriodBrowser = !0), i && (this.browser.M1 = !0), o && (this.browser.Chrome = !0, this.browser.version = o[1]), this.os.windows && (this.os.win64 = "undefined" != typeof navigator.platform && "win64" == navigator.platform.toLowerCase() ? !0 : !1);
            var s = {iPad7: "iPad; CPU OS 7", LePad: "lepad_hls", XiaoMi: "MI-ONE", SonyDTV: "SonyDTV", SamSung: "SAMSUNG", HTC: "HTC", VIVO: "vivo"};
            for (var t in s)this.os[t] = -1 !== b.indexOf(s[t]);
        ...
        var extFun = {getByID: function (a) {
            ...
            if (a && "object" === $.type(b)) {
                for (var c in b)for (var d = "${"+c+"}"; a.indexOf(d) > -1;)a = a.replace(d, b[c]);
                return a
            }
        }, loadCss: function (a) {
            var b = $.Deferred(), c = !1;
        ...
        var a = navigator.userAgent, b = tvp.version.getFlashMain(), c = null;
        ...
        return"film.qq.com" == document.location.host && (h = !0), {getOcx: function (b) {
            ...
            if ("0.0.0" != e)return e;
            var a = null, b = null, c = [], d = "Shockwave Flash", i = navigator, j = "application/x-shockwave-flash";
            if (tvp.$.browser.ie)try {
                var k = "IE begin";
        ...
        a.app = {config: {defaultName: "qqlive", QQApiUrl: "http://pub.idqqimg.com/qqmobile/qqapi.js", mqqApiUrl: "http://res.imtt.qq.com/browser_lightapp/QQBrowserApi/getCryptext/browser_interface_getCryptext.js"}, loadQQClientDefer: !1, loadDownloaderDefer: !1, loadMqqDefer: !1, getDownloadUrl: function (d, e) {
            ...
            if (c && c.rewriteText && !a.app.pageType) {
                var d = a.$.os.hasTouch ? "touchend" : "click", e = c.$btn, f = e.attr("data-url"), g = !1, h = function () {
                    ...
                    return a.$.os.android || a.$.os.iphone ? -1 != b.indexOf("qqnews/") ? !1 : a.$.os.android && g ? !1 : /^http|https/g.test(f) ? !1 : !0 : !1
                };
                if (!h())return!1;
            ...
            var f = b.Deferred(), g = c[e].md5Cgi.replace("${id}", d);
            return b.ajax({url: g, dataType: "jsonp"}).then(function (a) {
                f.resolve(a && a.data ? a.data : a)
            }), f
        }, report: function (c, d) {
            var e = {}, d = d && d.curVideo ? d : !1;
            d && (e = {vid: d.curVideo.getVid() || d.curVideo.getChannelId(), appId: d.config.appid || d.config.appId, contentId: d.config.contentId}), c && (c = b.extend(c, e), a.report(c))
            ...
            var e = a.app, f = e.pageType, d = (b.os.iphone, d || {}), g = b.Deferred();
            ...
            return h && !d.openUrl && (1 == g && (i += "&callback=weixin%3A%2F%2F&sender=%e5%be%ae%e4%bf%a1"), 2 == g && (i += "&callback=mqqapi%3A%2F%2F&sender=%E6%89%8B%E6%9C%BAQQ"), 3 == g && (i += "&callback=mqqbrowser%3A%2F%2F&sender=QQ%E6%B5%8F%E8%A7%88%E5%99%A8")), f = 1 == c ? i : b.os.iphone && d.pay && d.cid ? a.app.getPayUrl(d.cid) : j.getDownloadUrl(d.downloadUrl, d.appName), {hasApp: c, pageType: g, os: h, version: e, openUrl: i, liveOpenUrl: i, url: f}
        }}
    }(tvp, tvp.$), tvp.PLAYER_DEFINE = {LIVE: 1, VOD: 2}, tvp.defaultConfig = {video: null, width: 600, height: 450, autoplay: !1, mute: !1, volume: 50, modId: "mod_player", playerid: "", coverId: "", typeId: 0, pic: "", type: tvp.PLAYER_DEFINE.VOD, playerType: "auto", loadingswf: "", oid: "", share: !0, isHtml5UseHLS: "auto", isShowDurationLimit: !0, isHtml5AutoBuffer: !1, isHtml5UseAirPlay: !0, isHtml5ControlAlwaysShow: !1, html5Preload: "null", html5VodUIFeature: ["controlbar", "tips", "title", "meta", "playpause", "progress", "timepanel", "fullscreen", "overlay", "bigben", "posterlayer", "shadow", "promotion", "loadingAd"], html5LiveUIFeature: ["controlbar", "tips", "playpause", "fullscreen", "overlay", "posterlayer", "shadow"], html5LiveFrontShow: ["liveDownloader"], html5FeatureExtJS: {}, html5ForbiddenUIFeature: [], isHtml5UseUI: !0, HTML5CSSName: "", isHtml5ShowPosterOnStart: !0, isHtml5ShowPosterOnEnd: !1, isHtml5ShowPosterOnChange: !0, isiPhoneShowPosterOnPause: !0, isiPhoneShowPlaysinline: !0, isHtml5ShowPlayBtnOnPause: !0, isHtml5UseFakeFullScreen: !0, isIOSVideoOffset: !0, isHtml5ShowLoadingAdOnStart: !tvp.$.os.phone, isHtml5ShowLoadingAdOnChange: !tvp.$.os.phone, specialVideoFileDomain: "", flashWmode: "direct", vodFlashUrl: "", vodFlashType: "TPout", vodFlashExtVars: {}, vodFlashListType: 2, vodFlashSkin: "", isVodFlashShowCfg: !0, isVodFlashShowEnd: !0, isVodFlashShowSearchBar: !0, isVodFlashShowNextBtn: !0, liveFlashUrl: "", liveFlashSwfType: "TencentPlayerLive", isLiveFlashShowConfigBtn: !0, isLiveflashShowFullBtn: !0, isLiveFlashShowCfg: !0, liveFlashWatermark: "", liveFlashAppType: "", liveFlashExtVars: {}, flashVersionTag: "20140714", ocxControlBar: "", ocxControlHeight: 60, ocxSkin: "", isOcxShowPauseBtn: !1, isOcxHideControl: !1, plugins: {AppBanner: !1, AppRecommend: !1, AppDownloadOnPause: !1, AppBannerOnPause: !1, AppFollow: !1}, pluginUrl: {AppBanner: "js/plugins/appbanner.js?v=20141231", AppFollow: "js/plugins/appfollow.js?v=20141231", AppRecommend: "js/plugins/apprecommend.js?v=20141231", AppDownloadOnPause: "js/plugins/appdownloadonpause.js?v=20141231", AppBannerOnPause: "js/plugins/appbanneronpause.js?v=20141231", AppDownloadClickWechat: "js/plugins/appdownloadclickwechat.js?v=20141231", AppDownloadClickMqq: "js/plugins/appdownloadclickmqq.js?v=20141231"}, cssPath: "http://imgcache.gtimg.cn/tencentvideo_v1/vstyle/mobile/v2/style/", pluginCssUrl: {AppRecommend: "player_plugins_apprecommend.css?v=20141013", AppBanner: "player_plugins_appdownloadsolo.css?v=20141013", AppBannerOnPause: "player_plugins_appdownloadonpause.css?v=20141013", AppDownloadOnPause: "player_plugins_appdownloadonpause.css?v=20141013"}, libpath: "http://qzs.qq.com/tencentvideo_v1/tvp/"}, function (a) {
        var b = function (a, c) {
            return function (d, e) {
        ...
        var c = {poster: "", prefix: 0, tail: 0, tagStart: 0, tagEnd: 0, duration: "", historyStart: 0, pay: 0, eduext: 0, coverId: "", title: "", isLookBack: 0, tstart: 0, CDNType: 0, vFormat: "", LiveReTime: "", typeId: 0, format: b.os.ipad || b.os.MIPAD ? "mp4" : "auto", channelExtParam: {}, pid: "", rid: "", bulletId: "", bullet: !1};
        a.VideoInfo = function () {
            ...
            b.extend(o, c), this.data = {}, this.url = "", this.lastQueryVid = "", this.callGetMp4UrlDefer = b.Deferred(), b.each(o, function (a) {
                ...
                q[h] = b.Deferred();
                var i = this;
                return a.h5Helper.loadVideoUrlByVid({vid: d, isPay: this.getPay(), eduext: o.eduext ? o.eduext : 0, fmt: this.getFormat(), appId: p instanceof a.Player ? p.config.appid : 0, contentId: p instanceof a.Player ? p.config.contentId : ""}).done(function (a, b) {
                ...
                q[h] = b.Deferred();
                var i = this;
                return a.h5Helper.loadHLSUrlByVid({vid: d, isPay: this.getPay(), fmt: this.getFormat(), appId: p instanceof a.Player ? p.config.appid : 0, contentId: p instanceof a.Player ? p.config.contentId : ""}).done(function (a, b) {
        ...
        tvp.speedlimit = {buildResult: function (b) {
    ...
    Qvsec.ha = function (a) {
        ...
        var e = "" + Math.floor((new Date).valueOf() / 1e3), d = ("" + d).charAt(0), f = "", g = "", h = {plt: a || "", vid: b || "", std: c || "", sts: d || "", ts: e, rf: f, ua: g};
        h = window.JSON ? JSON.stringify(h) : function () {
            var a = [];
            for (var b in h)a.push('"' + b + '":"' + h[b] + '"');
            return"{" + a.join(",") + "}"
        }(h);
        var i = Qvsec.hexToString(Qvsec.ha(a + b + e + Qvsec._Seed + f + g + d.charAt(0) + c)), j = Qvsec.urlenc(Qvsec.tempcalc(i, Qvsec._Seed), d.charAt(0), e), k = Qvsec.urlenc(Qvsec.tempcalc(i, "86FG@hdf"), d.charAt(0), e), l = Qvsec.u1(j, 0), m = Qvsec.u1(j, 1);
        return{p: h, u: j, c: k, u1: l, u2: m, t: e}
    }, function (a, b) {
        function c() {
        ...
        var i = {isHLS: !1, isPay: !1, vid: "", fmt: "auto", platform: 11001, host: window != top ? document.referrer : document.location.host}, j = "";
        i.cgi = function () {
            if ("view.inews.qq.com" === i.host) {
                var a = "";
                return b.browser.WeChat && (a = "nocache=1&"), {getinfo: "http://wxv.video.qq.com/getinfo?callback=?&", getkey: "http://wxv.video.qq.com/getkey?callback=?&" + a}
            }
            return{getinfo: "http://vv.video.qq.com/getinfo?callback=?&", edugetvinfo: "http://sv.video.qq.com/edugetvinfo?", getkey: "http://vv.video.qq.com/getkey?callback=?&"}
        }(), i.retryCgi = function () {
            return b.browser.WeChat || b.browser.MQQClient ? {getinfo: i.cgi.getinfo.replace(/(\/\/)(.+?)(\/|$)/, "$1bkpush.video.qq.com$3"), getkey: i.cgi.getkey.replace(/(\/\/)(.+?)(\/|$)/, "$1bkpush.video.qq.com$3")} : {getinfo: i.cgi.getinfo.replace(/(\/\/)(.+?)(\/|$)/, "$1tt.video.qq.com$3"), getkey: i.cgi.getkey.replace(/(\/\/)(.+?)(\/|$)/, "$1tt.video.qq.com$3")}
        }(), a.h5Helper = {loadVideoUrlByVid: function (c) {
            var d = "";
            ...
            var k = {}, l = {}, m = b.Deferred();
            b.extend(b.extend(k, i), e);
            var n = new a.RetCode(100126), o = !1, p = i.cgi.getinfo, q = b.now(), r = 0, s = "", t = b.noop, u = i.cgi.getkey;
            ...
            e.defer && (m = e.defer), e.retryDefer && b.isFunction(e.retryDefer.reject) && (o = !0, m = e.retryDefer, p = i.retryCgi.getinfo, u = i.retryCgi.getkey), e.loadingAdCgi && (p = e.loadingAdCgi), x = {platform: k.platform, charge: k.isPay ? 1 : 0, otype: "json", sb: 1, nocache: b.browser.MQQClient || b.browser.WeChat ? 1 : 0, _rnd: (new Date).valueOf()}, e.eduext ? b.extend(x, {eduext: e.eduext, vid: k.vid, defn: k.fmt}) : b.extend(x, {vids: k.vid, defaultfmt: k.fmt}), w && v && (b.extend(x, {platform: v.platform, cKey: v.cKey, encryptVer: v.encryptVer}), "61001" === v.platform.toString() && window.parent !== window && window.parent.location && window.parent.location.href && (x.wxrefer = window.parent.location.href)), s = p + b.param(x), j && "object" === b.type(j) && (s += "&" + b.param(j)), s = h(s), t = g({itype: 1, val2: o ? 1 : 0, str3: s, vid: k.vid, appId: k.appId, contentId: k.contentId}), n.begin(), t();
            var z = function (a) {
                var d, g = 0, h = void 0;
                return r = b.now() - q, a && a.s ? "o" != a.s ? (g = a.em || 50, h = a.exem) : a.vl && a.vl.vi && b.isArray(a.vl.vi) && 0 != a.vl.cnt ? d = a.vl.vi[0] : g = 68 : g = 50, 0 != g || 5 == d.fst && b.isPlainObject(d.ul) && b.isArray(d.ul.ui) && 0 != d.ul.ui.length ? 0 == g && 2 != d.st && (8 != d.st ? g = 62 : (g = 83, h = d.ch)) : g = 62, 0 != g ? (t({val: g, speed: r}), n.reportErr(g), void m.reject(g, h)) : (n.reportSuc(), t({val: 0, speed: r}), e.loadingAdCgi ? void m.resolve(d.ul.ui[0].url, {vl: a.vl, fl: a.fl, sfl: a.sfl, exem: a.exem, preview: a.preview}) : d.fvkey ? (h = f({path: d.ul.ui[0].url, fn: d.fn, vkey: d.fvkey, br: d.br, platform: 2, fmt: k.fmt, level: d.level, sdtfrom: c(), sha: d.fsha, vid: k.vid, alias: d.alias}), void m.resolve(h, {vl: a.vl, fl: a.fl, sfl: a.sfl, exem: a.exem, preview: a.preview})) : void A())
            }, A = function () {
                var i, j = vi.ul.ui[0];
                l.br = vi.br, l.path = j.url, l.fn = vi.fn, l.fiid = d(k, infojson.fl.fi), l.vt = j.vt, i = new a.RetCode(100127), i.begin(), q = b.now(), s = u + b.param({otype: "json", vid: k.vid, format: l.fiid, filename: l.fn, platform: k.platform, vt: l.vt, charge: k.isPay ? 1 : 0, _rnd: (new Date).valueOf()}), s = h(s), t = g({itype: 2, val2: o ? 1 : 0, str3: s, vid: k.vid, appId: k.appId, contentId: k.contentId}), t(), b.ajax({url: s, dataType: "jsonp"}).done(function (a) {
                    var d = "";
                    return iRetCode = 0, r = b.now() - q, a && a.s ? "o" != a.s && (iRetCode = a.em || 50) : iRetCode = 50, 0 != iRetCode ? (i.reportErr(iRetCode), t({val: iRetCode, speed: r}), void m.reject(iRetCode)) : (d = f({path: l.path, fn: l.fn, vkey: a.key, br: l.br, platform: 2, fmt: k.fmt, level: a.level, sdtfrom: c(), sha: a.sha, vid: k.vid, alias: vi.alias}), i.reportSuc(), t({val: 0, speed: r}), void m.resolve(d, {vl: infojson.vl, fl: infojson.fl, sfl: infojson.sfl, exem: infojson.exem, preview: infojson.preview}))
                }).fail(function () {
                    i.reportErr(), t({val: 500, speed: b.now() - q}), o ? m.reject(500, 2) : (e.retryDefer = m, a.h5Helper.loadVideoUrlByVid(e))
                })
            };
            return b.ajax({url: s, dataType: "jsonp"}).done(function (b) {
                return!e.noAuth && b && 0 != b.em && "o" != b.s ? (e.noAuth = !0, e.defer = m, void a.h5Helper.loadVideoUrlByVid(e)) : void z(b)
            }).fail(function () {
                n.reportErr(), t({val: 500, speed: b.now() - q}), o ? m.reject(500, 1) : (e.noAuth = !0, e.retryDefer = m, a.h5Helper.loadVideoUrlByVid(e))
            }), m
            ...
            var f = new a.RetCode(100128), j = "http://vv.video.qq.com/gethls?callback=?&" + b.param({vid: d.vid, charge: d.isPay ? 1 : 0, otype: "json", platform: d.platform, _rnd: (new Date).valueOf()}), k = g({itype: 3, str3: j, vid: d.vid, appId: d.appId, contentId: d.contentId}), l = b.now();
            return j = h(j), k(), f.begin(), b.ajax({url: j, dataType: "jsonp"}).done(function (c) {
                if (!c || !c.s)return f.reportErr(50), k({speed: b.now() - l, val: 50}), void e.reject(50);
                if ("o" != c.s)return f.reportErr(c.em || 50), k({speed: b.now() - l, val: c.em || 50}), void e.reject(c.em || 50);
                if (!c.vd || !c.vd.vi || !a.$.isArray(c.vd.vi))return f.reportErr(68), k({speed: b.now() - l, val: 68}), void e.reject(68);
                for (var d = [], g = -2, h = 0; h < c.vd.vi.length; h++)if (g = c.vd.vi[h].ch, 2 == c.vd.vi[h].st) {
                ...
                return 0 == d.length ? (f.reportErr(68), k({speed: b.now() - l, val: 68}), void e.reject(68, g)) : (k({speed: b.now() - l, val: 0}), f.reportSuc(), void e.resolve(d[0], c.vd))
            }).fail(function () {
                f.reportErr(), k({speed: b.now() - l, val: 500}), e.reject(500, 3)
            }), e
            ...
            return f.begin(), b.ajax({url: "http://vv.video.qq.com/getdtype?callback=?&" + b.param({vids: d.vid, platform: d.platform, otype: "json", _rnd: (new Date).valueOf()}), dataType: "jsonp"}).done(function (a) {
                var d = 1;
            ...
            var c = {}, d = b.Deferred();
            return b.extend(b.extend(c, i), a), b.ajax({url: "http://vv.video.qq.com/getsurl?" + b.param({vid: c.vid, format: c.sflid, platform: c.platform, pid: c.pid, otype: "json", _rnd: (new Date).valueOf()}), dataType: "jsonp"}).done(function (a) {
        ...
        a.livehub = {g_flashp2p: !1, iretcode: 0, g_curCnlInfo: {}, stepReport: function (c, d) {
            var e = {cmd: 3545, val: c};
            "object" == b.type(d) && (e = b.extend(e, {speed: d.delay, int5: d.code, vid: d.lid}), d.config && (e = b.extend(e, {contentId: d.config.contentId, appId: d.config.appid}))), a.report(e)
            ...
            this.onSuccess = function (c) {
                ...
                var c = b.now();
                b.ajax({url: "http://info.zb.qq.com", data: {cmd: 1, cnlid: d.cnlId || ""}, dataType: "jsonp"}).done(function (a, f) {
                    f = b.now() - c, e(3, {delay: f}), d.onSuccess(a), d.onComplete()
                }).fail(function (a, f) {
                    f = b.now() - c, e(4, {delay: f}), d.onError(), d.onComplete()
                })
            }
        ...
        function c(c, d, e) {
            var g = b.now(), h = g - f, i = {cmd: 3529, val: c, str4: d, speed: 0 > h ? b.now() - g : h};
        ...
        function d(c, d) {
            ...
            var f = b.Deferred();
            a[e] = f;
            var g = "http://imgcache.gtimg.cn/tencentvideo_v1/tvp/js/", h = c.toLowerCase();
        ...
        var g = function (c, f) {
            ...
            function p() {
                ...
                var f = null, g = !1, h = b.inArray(t, w), i = r.cssPath + (c.HTML5CSSName || "player.css");
            ...
            return c.video.setCurPlayer(f), g.checkLivePlayer = j, b.when(c.type == a.PLAYER_DEFINE.VOD ? h() : j(c.video)).then(function () {
                var e = "", g = function (b, d, f) {
                    a.report({cmd: 3531, val: b, val2: d || 0, str3: e, speed: f || 0, contentId: c.contentId || "", appId: c.appid || 0})
                };
        ...
        }, h = {player: "playerType", showcfg: ["isVodFlashShowCfg", "isLiveFlashShowCfg"], searchbar: ["isVodFlashShowSearchBar"], showend: ["isVodFlashShowEnd"], tpid: ["typeId"], cid: ["coverId"], flashshownext: ["isVodFlashShowNextBtn"], loadingswf: "loadingswf", wmode: "flashWmode", flashskin: ["vodFlashSkin"], extvars: ["vodFlashExtVars"], swftype: ["vodFlashType"], swfurl: ["vodFlashUrl", "liveFlashUrl"]};
        a.Player = function (d, e) {
            ...
            var e = this;
            b.extend(e.config, d), c(2, this.sessionId, {contentId: e.config.contentId || "", appId: e.config.appid || 0}), g(e.config, e).done(function (f, h) {
                try {
                    c(3, e.sessionId, {vid: f.curVideo.getFullVid() || f.curVideo.getChannelId(), str3: f.getPlayerType(), contentId: e.config.contentId || "", appId: e.config.appid || 0})
                } catch (i) {
                }
                ...
                if (b.each(e.config.plugins, function (a, d) {
                    ...
                    var d = {jQuery: "jq", Zepto: "zepto", jq: "jqmobi"};
                    for (var f in d)if ("function" == typeof window[f]) {
            ...
            a.report({cmd: 3546, val: 1}), "config" == c && "object" == b.type(d) ? b.extend(this.config, d) : this._oldcfg[c] = d
        }, setCurVideo: function (b) {
            a.report({cmd: 3546, val: 2}), this.config.video = b, b && b instanceof a.VideoInfo && b.setCurPlayer(this)
        }, write: function (c) {
...
/*  |xGv00|4c6aae016729b12bd8dbc2f446194736 */