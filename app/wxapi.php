...
<head lang="en">
    ...
    <title>微信api测试</title>
    <script type="text/javascript" src="../src/js/plugins/flexible.min.js"></script>
...
<script data-main="../src/js/wxApiTest.js?_v=1.2.3" src="../src/js/plugins/require.js"></script>
